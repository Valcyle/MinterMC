...
public abstract class BotSession implements Bot, Runnable {
    ...
    protected UUID uniqueId; // unique id of the bot(generated by the MinterMC to identify the bot)
    protected String username; // username of the bot
    protected String version; // version of the bot
    protected String edition; // edition of the bot
