 ...
 * <br>
 * Protocol differences (Java Edition / Bedrock Edition) are abstracted away behind this interface.
 * Plugin developers will use this interface to perform movements, retrieve environment data, and send high-level packets.
 */
public interface Bot {
     ...
     * <br>
     * This method itself does not perform pathfinding. It may emulate "linear movement" or
     * "simple forward progression" packets provided by the kernel.
     * More advanced pathfinding (like A*) is intended to be implemented or overridden by plugins
     ...
     * <br>
     * If an uncached area is requested, an exception may be thrown or an empty/air block will be returned (depending on implementation).
     *
     * @param x The target X coordinate
     * @param y The target Y coordinate
     * @param z The target Z coordinate
    ...
    /**
     * Returns the current connection state of this bot (e.g., logged in, disconnected).
     *
